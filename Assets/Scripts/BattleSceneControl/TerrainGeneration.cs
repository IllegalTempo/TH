...
public class TerrainGeneration : MonoBehaviour
{
    ...
    private int LOD = 1;
    private Vector3[] GenerateGrassPlaneVertices(Vector2 size, out Vector2[] uv, out Vector3[] normal, bool spawntree, AnimationCurve hc)
    {
    ...
    //    return false;
    //}
    public void Generate(int seed, GridSystem.ChunkType t, Vector2 size, bool spawntree, AnimationCurve heightc)
    {
        ...
        switch (t)
        {
            case GridSystem.ChunkType.GrassPlane:
                vertices = GenerateGrassPlaneVertices(size, out uv, out normals, spawntree, heightc);
                break;
        }
